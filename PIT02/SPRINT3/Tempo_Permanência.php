...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['tempo'])) {
    ...
    switch ($tempoSelecionado) {
        case '30':
            $pagina = 'gerar_qrcode_30min.php'; // Página para 30 minutos
            break;
        case '300':
            $pagina = 'gerar_qrcode_5h.php'; // Página para 5 horas
            break;
        case '600':
            $pagina = 'gerar_qrcode_10h.php'; // Página para 10 horas
            break;
        case '1440':
            $pagina = 'gerar_qrcode_24h.php'; // Página para 24 horas
            break;
        default:
